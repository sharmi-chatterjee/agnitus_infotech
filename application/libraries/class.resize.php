...
class imageResize
{
    ...
    public function resize($Scr, $NewDir, $NewWidth,$filename_prefix, $Compr = NULL, $Conv = NULL, $Trans = FALSE)
    {
        $this->Scr      = $Scr;
        $this->NewDir   = $NewDir;
        ...
        if ($this->Conv == NULL) {
            switch ($size['mime']) {
                case "image/gif":
					...
					$thumb_name  = $filename_prefix . ".gif";
					$newfilename = $directoryName . "/" . $thumb_name;
					
                    break;
                case "image/jpeg":
				    $thumb_name  = $filename_prefix . ".jpeg";
                    $newfilename = $directoryName . "/" . $thumb_name;
                    break;
                case "image/png":
				    $thumb_name  = $filename_prefix . ".png";
                    $newfilename = $directoryName . "/" . $thumb_name;
                    break;
                case "image/webp":
				    $thumb_name  = $filename_prefix . ".webp";
                    $newfilename = $directoryName . "/" . $thumb_name;
                    break;
            }
        } else {
			$thumb_name  = $filename_prefix . "." . $this->Conv;
            $newfilename = $directoryName . "/" . $thumb_name;
        }
        $this->newfilename = $thumb_name;
